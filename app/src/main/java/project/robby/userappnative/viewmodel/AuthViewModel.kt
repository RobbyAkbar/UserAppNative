...
class AuthViewModel @Inject constructor(
    ...
    private val _forgotFlow = MutableStateFlow<Resource<String>?>(null)
    val forgotFlow: StateFlow<Resource<String>?> = _forgotFlow
    ...
    fun forgot(email: String) = viewModelScope.launch {
        _forgotFlow.value = Resource.Loading
        val result = repository.forgot(email)
        _forgotFlow.value = result
    }
